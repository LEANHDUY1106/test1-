...
export class ManageRequestComponent implements OnInit {
  ...
  async ngOnInit(): Promise<void> {
    ...
    this._searchService.currentState.subscribe(state => {
      ...
      this.searchInput.assigner = state?.assigner ? state?.assigner : "";
    ...
    //nếu đã có quyền admin rồi thì ko check nữa còn chưa thì check tiếp
    // if (!this.isAdmin) {
    //   this.isAdmin = await this.checkPersion();
    // }
    ...
    // }
    // this.loadDataType();
    this._backDetailService.changeState(0);
    // if (this.isMyManage) {
    //   // this.clearSearch();
    //   this.searchInput.createdUser = this.session.user.userName;
    //   this.labelList = "Yêu cầu đã tạo";
    //   this._backDetailService.changeState(1);
    //   this.searchState.createdUser = this.searchInput.createdUser;
    ...
    // if (this.isMyFollow) {
    //   // this.clearSearch();
    //   this.searchInput.followup = 1;
    //   this.labelList = "Yêu cầu đang theo dõi";
    //   this._backDetailService.changeState(3);
    // }
    // if (this.isMyAssignManage) {
    //   // this.clearSearch();
    //   this.searchInput.assigner = this.session.user.userName.toLowerCase();
    //   this.labelList = "Yêu cầu được phân công";
