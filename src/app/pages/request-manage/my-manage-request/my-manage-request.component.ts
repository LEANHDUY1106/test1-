...
import { MyManageSearchService } from './my-manage.service';

@Component({
  templateUrl: './my-manage-request.component.html',
  styleUrls: ['./my-manage-request.component.scss']
})
export class MyManageRequestComponent implements OnInit {
  ...
  constructor(
    ...
    private _searchService: MyManageSearchService
  ) {
  }
