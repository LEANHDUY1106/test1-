...
import { SearchDebtAssignDebtService } from './search-debt-assign.service';

@Component({
  templateUrl: './list-debt-assign.component.html',
  styleUrls: ['./list-debt-assign.component.scss']
})
export class ListDebtAssignComponent implements OnInit {
  ...
  constructor(private router: Router,
    ...
    private _searchService: SearchDebtAssignDebtService,
  ...
  ngOnInit(): void {
    ...
    this.requestSearch.p_demaccount = this.session.user.email.split('@')[0].toLowerCase();
  ...
  refeshSearch() {
    this.requestSearch = {
      p_contractnumber: '',
      p_status: '1',
      p_demaccount: this.session.user.email.split('@')[0].toLowerCase(),
      invoicenumber: '',
      startDate: null,
      endDate: null,
      customername: '',
